export const projects = [
  ...
  },
  {
    ...
    technologies: ['React.js', 'JavaScript', 'HTML', 'CSS', 'SpotifyAPI'],
    deployed: 'GitHub Pages',
    job: 'Software Engineer',
  ...
  },
  {
    ...
    technologies: ['React.js', 'JavaScript', 'HTML', 'CSS', 'YelpAPI'],
    deployed: 'GitHub Pages',
    job: 'Software Engineer',
  ...
  },
  {
    ...
    technologies: ['React.js', 'JavaScript', 'HTML', 'CSS', 'Node.js', 'Express', 'MySQL', 'MERN'],
    deployed: 'N/A',
    job: 'Software Engineer',
  ...
  },
  {
    ...
    technologies: ['React.js', 'JavaScript', 'HTML', 'CSS', 'Node.js', 'Express', 'CassandraDB', 'PostgreSQL', 'PERN'],
    deployed: 'N/A',
    job: 'Software Engineer',
