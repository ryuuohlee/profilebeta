...
export const jobs = [
  ...
  },
  {
    ...
    location: 'USA',
    companyImg: 'https://jeffreyleeportfolio.s3-us-west-1.amazonaws.com/360invest2.png',
  ...
  },
  {
    ...
    location: 'USA',
    companyImg: 'https://jeffreyleeportfolio.s3-us-west-1.amazonaws.com/accenture.png',
    description: 'Maintained quality metrics across client projects for both the content review analysts and the store.',
  ...
  },
  {
    ...
    location: 'USA',
    companyImg: 'https://jeffreyleeportfolio.s3-us-west-1.amazonaws.com/visionit.png',
    description: 'Provided quality assurance checks of agents to promote positive user experiences.',
  ...
  },
  {
    ...
    location: 'USA',
    companyImg: 'https://jeffreyleeportfolio.s3-us-west-1.amazonaws.com/visionit.png',
    description: 'Improved the user experience of the consumer products and services in the store by understanding and enforcing the policy and reviewing a large volume of content.',
  ...
  },
  {
    ...
    location: 'USA',
    companyImg: 'https://jeffreyleeportfolio.s3-us-west-1.amazonaws.com/visionit.png',
    description: 'Protected and improved the user experience of the consumer products and services in the store.',
  ...
  },
  {
    ...
    location: 'USA',
    companyImg: 'https://jeffreyleeportfolio.s3-us-west-1.amazonaws.com/cinemark.jpg',
    description: 'Managed the daily operations of this large-scale business, being second only to the general manager.',
  ...
  },
  {
    ...
    location: 'USA',
    companyImg: 'https://jeffreyleeportfolio.s3-us-west-1.amazonaws.com/cinemark.jpg',
    description: 'Installed and maintained all theater computerized technologies.',
  ...
  },
  {
    ...
    location: 'USA',
    companyImg: 'https://jeffreyleeportfolio.s3-us-west-1.amazonaws.com/cinemark.jpg',
    description: 'Managed operations of the assigned department ensuring 100% customer satisfaction.',
    achievements: ['Ensured smooth operations of my department and keeping shrinkage down.', 'Created the inventory tools that were used for record-keeping.', `Continually contributed to ensuring high scoring auditing results for my department from company audits.`]
  },
]