    ...
    <div>
      <div className="site-main">
        <div className="welcome">
          ...
          <p className="site-main-welcome-info"> a full-stack software engineer and I enjoy <span className="welcome-highlight">building things</span> that <span className="welcome-difference">make a difference!</span>
          </p>
        </div>
